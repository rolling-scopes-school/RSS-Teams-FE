...
export const SET_COURSE_SELECT_OPEN = 'SET_COURSE_SELECT_OPEN';
export const SET_HEADER_LANG_SELECT_OPEN = 'SET_HEADER_LANG_SELECT_OPEN';
export const SET_BURGER_MENU_SELECT_OPEN = 'SET_BURGER_MENU_SELECT_OPEN';
